...
一边,是过去十几年已经非常成熟的低代码路径。表单、流程、审批、门户、报表,这套体系已经帮助很多企业把大量业务流程搬到了线上。以公开产品定位来看,像云之家/宜搭这样的产品,本质上是在做低代码应用搭建平台;云之家相关轻应用能力,强调的也是协同场景下的业务应用快速搭建。它们解决的是一个非常重要的问题: 让企业更快把系统做出来。
